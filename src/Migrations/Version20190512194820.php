 ...
 */
final class Version20190512194820 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, psycho_id INT NOT NULL, created_at DATETIME NOT NULL, contenu VARCHAR(255) NOT NULL, INDEX IDX_67F068BC90E26EFF (psycho_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BC90E26EFF FOREIGN KEY (psycho_id) REFERENCES psychologue (id)');
