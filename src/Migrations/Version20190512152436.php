 ...
 */
final class Version20190512152436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE role_psychologue (role_id INT NOT NULL, psychologue_id INT NOT NULL, INDEX IDX_E49C500ED60322AC (role_id), INDEX IDX_E49C500E465459D3 (psychologue_id), PRIMARY KEY(role_id, psychologue_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE role_psychologue ADD CONSTRAINT FK_E49C500ED60322AC FOREIGN KEY (role_id) REFERENCES role (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE role_psychologue ADD CONSTRAINT FK_E49C500E465459D3 FOREIGN KEY (psychologue_id) REFERENCES psychologue (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE role_psychologue DROP FOREIGN KEY FK_E49C500ED60322AC');
        $this->addSql('DROP TABLE role');
        $this->addSql('DROP TABLE role_psychologue');
