 ...
 */
final class Version20190515170828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conversation (id INT AUTO_INCREMENT NOT NULL, auteur_id INT NOT NULL, commentaire_id INT DEFAULT NULL, created_at DATETIME NOT NULL, reponse LONGTEXT NOT NULL, INDEX IDX_8A8E26E960BB6FE6 (auteur_id), INDEX IDX_8A8E26E9BA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE conversation ADD CONSTRAINT FK_8A8E26E960BB6FE6 FOREIGN KEY (auteur_id) REFERENCES psychologue (id)');
        $this->addSql('ALTER TABLE conversation ADD CONSTRAINT FK_8A8E26E9BA9CD190 FOREIGN KEY (commentaire_id) REFERENCES commentaire (id)');
